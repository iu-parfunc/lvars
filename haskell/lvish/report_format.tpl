...
<html>
 <head>
    ...
    <title>LVish criterion report, generated on machine ???? </title>
...
{{#include}}criterion.css{{/include}}
    ...
    <h1>LVish criterion performance measurements</h1>
...
$(function () {
  ...
  o = $.plot(oq, xs, { bars: { show: true, horizontal: true,
                       ...
                       xaxis: { 
//                                transform: function(v) { return Math.log(v+0.00000001); }, 
                                max: Math.max.apply(undefined,means[0]) * 1.02 },
