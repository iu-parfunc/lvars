...
-- | A unique exception type for when a thread wants to use its escape continuation.
data ExitEarly = ExitEarly deriving (Show,Read,Eq,Typeable)

instance E.Exception ExitEarly where
