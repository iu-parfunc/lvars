...
type ParVec2 s1 elt1 elt2 det s2 ans =
     ParST (STTup2 (UVectorFlp elt1) (UVectorFlp elt2) s1) det s2 ans
...
runParVec2 :: forall elt1 elt2 s2 det ans . (MU.Unbox elt1, MU.Unbox elt2) =>
             (Int,Int)
...
runParVec2' :: forall elt1 elt2 ans . (MU.Unbox elt1, MU.Unbox elt2) =>
              (Int,Int)
...
reify :: ParVec2 s1 elt1 elt2 det s2 (MU.MVector s1 elt1, MU.MVector s1 elt2)
reify = do
